<p align="center">
  <img src="web/public/logo.svg" width="88" alt="祥子绘境 logo">
</p>

<h1 align="center">祥子绘境</h1>
...
一个故事也许始于一页小说、一个人物，或一句还没写完的对白。祥子绘境从章节中梳理角色与情节，让人物的外观、声音和气质成为可复用的角色资产，再把分镜、图片、视频和音频组织在同一张画布上。从最初的文字到可以被看见、被听见的镜头，创作者始终掌握故事的方向。

祥子绘境是一款面向 AI 影视与短剧创作的开源工作台，集成自由画布、结构化分镜、角色卡、3D 导演台、素材库、异步生成任务和 Agent 协作能力。
...
<p align="center">
  <img src="assets/qq.jpg" alt="祥子绘境 QQ 交流群" width="360">
</p>
